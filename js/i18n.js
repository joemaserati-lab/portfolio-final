(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      'boot.note': 'Tilt interaction may require motion sensor access on mobile.',
      ...
      'boot.readyNote': 'Tilt access may be requested on supported devices.',
      'boot.readyNoteDesktop': '',
      'boot.readyNoteInsecure': 'Tilt requires HTTPS on mobile.',
      'boot.requestTilt': 'REQUESTING MOTION ACCESS',
      'boot.requestTiltNote': 'Allow motion access to use tilt interaction.',
    ...
    it: {
      ...
      'boot.note': 'Su mobile l\'interazione tilt può richiedere l\'accesso ai sensori di movimento.',
      ...
      'boot.readyNote': 'Sui dispositivi compatibili potrebbe essere richiesto l\'accesso ai sensori.',
      'boot.readyNoteDesktop': '',
      'boot.readyNoteInsecure': 'Il tilt su mobile richiede HTTPS.',
      'boot.requestTilt': 'RICHIESTA ACCESSO AI SENSORI',
      'boot.requestTiltNote': 'Consenti l\'accesso ai sensori per utilizzare l\'interazione tilt.',
