(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      'boot.readyNoteInsecure': 'Touch + ambient motion mode is ready.',
      'boot.requestTilt': 'TOUCH MODE READY',
      'boot.requestTiltNote': 'Touch + ambient motion is enabled automatically.',
    ...
    it: {
      ...
      'boot.readyNoteDesktop': '',
      'boot.readyNoteInsecure': 'Modalità touch + movimento ambient pronta.',
      'boot.requestTilt': 'MODALITÀ TOUCH PRONTA',
      'boot.requestTiltNote': 'Touch + movimento ambient sono attivi automaticamente.',
