(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      'portfolio.selectedCopy': 'A selection of freelance digital projects and ongoing work across design, web and marketing.',
    ...
    it: {
      ...
      'hero.cta': 'VEDI LAVORI SELEZIONATI',
      'nav.aria': 'Sezioni del portfolio',
      'nav.projects': 'PROGETTI',
      'nav.projectsSmall': '05 VOCI',
      'nav.about': 'PROFILO.TXT',
      'nav.aboutSmall': 'PROFILO',
      'nav.resume': 'CV.TXT',
      'nav.resumeSmall': 'ESPERIENZA',
      ...
      'privacy.copy': 'Il sito può usare GA4 solo dopo consenso. Non usa cookie marketing o profilazione. Lingua, privacy e preferenze analytics vengono salvate localmente.',
      ...
      'portfolio.contactCopy': 'Progetti freelance selezionati, collaborazioni e opportunità creative.',
      ...
      'portfolio.selectedCopy': 'Una selezione di progetti digitali freelance e lavori continuativi tra design, web e marketing.',
      ...
      '404.kicker': 'PORTFOLIO OS / ROUTE ERROR',
      '404.copy': 'Il percorso richiesto è fuori dal sistema visivo. Torna alla home del portfolio o apri la directory dei lavori selezionati.',
