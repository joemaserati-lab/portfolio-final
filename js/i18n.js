(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      'boot.readyNote': 'Click to enter. Tilt access may be requested on supported devices.',
    ...
    it: {
      ...
      'boot.readyNote': 'Clicca per entrare. Sui dispositivi compatibili potrebbe essere richiesto l\'accesso ai sensori.',
